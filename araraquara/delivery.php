...
<script>
	function monta_loja(data) {
		$.each(data, function(i, loja) {
			...
			if (loja.loja_imagem_1_url) {
				...
				imagem = loja.loja_imagem_2 ? apis.upload_site_loja + loja.loja_imagem_2 : (loja.loja_imagem_1 ? apis.upload_site_loja + loja.loja_imagem_1 : 'https://upload.madnezz.com.br/178bb77ef606f034b225aa12ab3b41ff');
			}
	...
	$(function() {
		$.ajax({
			url: apis.loja + "?tipo=1,2,3&shopping_id=204&filtro_ramo=12423&full=true&jsoncallback=?",
			dataType: "json"
		}).done(function(data) {
			monta_loja(data);
		});
