...
<div class="banner" style="background-image:url(https://upload.madnezz.com.br/fbe4f1ebd3af30061ade545a6fea51f9)"></div>

<div id="servico" class="conteudo">	
    <div class="bg_cinza">
    	<div class="col">
        	<!--<p class="center pb50">Pensado em seu conforto e comodidade, o Shopping Jaraguá Araraquara conta com um mix de serviços variados que facilitam suas compras e momentos de lazer.</p>-->
        	<div class="titulo">
				<h1>Nova Pesquisa</h1>
			</div>    
    		<div class="faixa"> 
